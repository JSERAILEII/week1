...
namespace Lab2
{
    class Constitution
    {
        static void Main(string[] args)
        {
            ...
            int sixthLength = amendment6.Length;
            int freeExercise = amendment1.IndexOf("free exercise");
            String aThird = amendment3.ToUpper();
            string aNineth = amendment9.Substring(45, 33);
            string aEigth = amendment8.Substring(66,1);
            //or you could say: admendment8[67;]
            /* Console.Write() prints the content inside quotation */
            Console.WriteLine($"The substring at position 45 is {amendment6} and is should be {amendment6.Length} long");

           //or: Console.WriteLine("The substring at position 45 is {0} and is should be {1} long", amendment6, amendment6.Length);
           //or: Console.WriteLine("The substring at position 45 is " + amendment6 + " and is should be " + amendment6.Length + "long"); ;
